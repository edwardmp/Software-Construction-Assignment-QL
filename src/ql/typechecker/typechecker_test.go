...
func (suite *TypeCheckerTestSuite) TestUndefinedQuestionReferenceChecker() {
    ...
    exampleBody := stmt.NewStmtList([]interfaces.Stmt{computedQuestion})
...
func (suite *TypeCheckerTestSuite) TestNonBoolConditionalChecker() {
    ...
    exampleIf := stmt.NewIf(expr.NewIntegerLiteral(10), stmt.NewStmtList([]interfaces.Stmt{exampleQuestion}))
    exampleBody := stmt.NewStmtList([]interfaces.Stmt{exampleIf})
    exampleForm := stmt.NewForm(vari.NewVarID("TestForm"), exampleBody)
...
func (suite *TypeCheckerTestSuite) TestDuplicateLabelChecker() {
    ...
    exampleBody := stmt.NewStmtList([]interfaces.Stmt{firstQuestion, secondQuestion})
    exampleForm := stmt.NewForm(vari.NewVarID("TestForm"), exampleBody)
...
func (suite *TypeCheckerTestSuite) TestCyclicReferenceCheckerReferenceToEachOther() {
    ...
    exampleBody := stmt.NewStmtList([]interfaces.Stmt{questionPointingToFirstQuestion, questionPointingToSecondQuestion})
    exampleForm := stmt.NewForm(vari.NewVarID("TestForm"), exampleBody)
...
func (suite *TypeCheckerTestSuite) TestCyclicReferenceCheckerIfConditionRefersToBody() {
    ...
    ifBodyExample := stmt.NewStmtList([]interfaces.Stmt{questionExample})
    ifExample := stmt.NewIf(expr.NewVarExpr(vari.NewVarID("hasSoldHouse")), ifBodyExample)
    exampleFormBody := stmt.NewStmtList([]interfaces.Stmt{ifExample})
...
func (suite *TypeCheckerTestSuite) TestQuestionTypeAndComputationTypeMismatch() {
    ...
    exampleBody := stmt.NewStmtList([]interfaces.Stmt{exampleQuestion})
    exampleForm := stmt.NewForm(vari.NewVarID("TestForm"), exampleBody)
...
func (suite *TypeCheckerTestSuite) TestThatCorrectFormYieldsNoErrorsOrWarnings() {
    ...
    ifBody := stmt.NewStmtList([]interfaces.Stmt{firstQuestionBody})
    elseBody := stmt.NewStmtList([]interfaces.Stmt{firstQuestionBody})
    ifExample := stmt.NewIfElse(expr.NewBoolLiteral(true), ifBody, elseBody)
    exampleBody := stmt.NewStmtList([]interfaces.Stmt{firstQuestion, ifExample})
    exampleForm := stmt.NewForm(vari.NewVarID("TestForm"), exampleBody)
